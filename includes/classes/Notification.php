...
class Notification
{
	...
	/* 
	20:36:20 24 Sep, 2019 by Arjun Adhikari
	...
	*/
	...
	/* 
	20:37:20 24 Sep, 2019 by Arjun Adhikari
	Returns the no of unread notifications. 
	*/
	...
	/* 
	20:37:20 24 Sep, 2019 by Arjun Adhikari
	Returns the notifications with the limit(no. of notification that could be showed) value provided. 
	*/
	public function getNotifications($data, $limit)
	{
		...
		while ($row = mysqli_fetch_array($query)) {
            ...
            Timeframe calculation by subtracting current time from the time the event was generated.
		...
		/* 
		20:40:20 24 Sep, 2019 by Arjun Adhikari
		When count exceeds the limit, then next page is fetched. 
		*/
		if ($count > $limit)
	...
	/* 
	20:41:20 24 Sep, 2019 by Arjun Adhikari
	When some event is occured, then notification is to be stored on the database.
	Logic for that operation. 
	*/
